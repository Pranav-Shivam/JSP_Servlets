                        ...
                        <table width="100%">
                            <tr>                                                     
                                <td style="vertical-align: middle;text-align: left;">
                                    <input style="color: #149bdf" type="Button" id="placement" name="placement" value="For Placement" >  
                                    <input style="color: #149bdf" type="Button" id="training" name="training" value="For Training" >
                                </td>                               
                            </tr>  
                        </table>
