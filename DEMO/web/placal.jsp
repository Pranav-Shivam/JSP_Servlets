<%-- 
    Document   : placal
    Created on : 23 Feb, 2017, 7:46:54 PM
    Author     : DOLPHIN
--%>
	...
	<div id="wrapper">
    	...
    	<div class="container">
      		...
      		<div class="hero-unit">
                   ...
                   <h2>Contact Details [T&P Cell]</h2>
                    <p>                            </p>
        		...
        		<table style="width:100%">
                              ...
                              <tr>
                                <td>Ms. Anvita Varshney</td>
                                <td>Training & Placement Officer (T.P.O)</td> 
                                <td>0591-2475080, Telefax: 0591-2476806, +91 8057100444</td>
                                <td>placement.comp.app@tmu.ac.in</td>
                              </tr>
                               <tr>
                                <td>Mr. Vinay Prakash</td>
                                <td>Member</td> 
                                <td>+91 9760395831</td>
                                <td>vinay.computers@tmu.ac.in</td>
                              </tr>
                               <tr>
                                <td>Mr. Navneet Kumar Vishnoi-2</td>
                                <td>Member</td> 
                                <td>+91 9760642234</td>
                                <td>naveent.computers@tmu.ac.in</td>
                              </tr>
                               <tr>
                                <td>Mr. Manish Tiwari</td>
                                <td>Member</td> 
                                <td>+91 9760642234</td>
                                <td>manish.computer@tmu.ac.in</td>
                              </tr>
                              <tr>
                                <td>Mr. Pradeep Kumar Gupta</td>
                                <td>Member</td> 
                                <td>+91 9760642234</td>
                                <td>pradeepg.computers@tmu.ac.in</td>
                              </tr>
                              <tr>
                                <td>Mr. Shrikant Kumar Agarwal</td>
                                <td>Member</td> 
                                <td>+91 9760642234</td>
                                <td>shrikant.computer@tmu.ac.in</td>
                              </tr>
                              <tr>
                                <td>Mr. Mahendra Singh Sagar</td>
                                <td>Member</td> 
                                <td>+91 9760642234</td>
                                <td>mahendra.computers@tmu.ac.in</td>
                              </tr>
                              
                            </table>
                        <br/>
                                                  
                         <h2>Industry Linkage</h2>    
                            <table style="width:100%">
                               <tr>
                                <th>S. No.      </th>
                                <th>Member Name</th> 
