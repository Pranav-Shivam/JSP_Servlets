        ...
        <script type="text/javascript">
         $(function () {
          ...
          $(document).ready(function () 
          {
                ...
                actions: {
                    listAction: '.../Servlet_Apply_Reject?action=list',                                  
                },
                fields: {
                    refno: {
                            title:'Reference Id',
                        ...
                        <table width="100%">
                            <tr>                                                     
                                <td style="vertical-align: middle;text-align: left;">
                                    <input style="color: #149bdf" type="Button" id="Apply" name="Apply" value="Apply" >  
                                    <input style="color: #149bdf" type="Button" id="Reject" name="Reject" value="Reject" >
                                </td>                               
                            </tr>  
                        </table>
