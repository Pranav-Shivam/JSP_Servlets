    ...
    <body>
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="../recruiter/recuiter_entry.jsp">Recruiters Entry</a>
                            </li>
                            <li>
                                <a href="../recruiter/edit_recruiter.jsp">Edit Recruiters</a>
                            </li>                           
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-table "></i>Notice Uploading</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-edit "></i>Approve Student</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-sitemap "></i>Event Generation<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">For Placement</a>
                            </li>
                            <li>
                                <a href="#">For Training</a>
                            </li>                           
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-sitemap "></i>Recruitment Record<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">Visiting Record<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="#">By Session</a>
                                    </li>
                                    <li>
                                        <a href="#">By Session and Course</a>
                                    </li>
                                    <li>
                                        <a href="#">By Session and Course Type</a>
                                    </li>
                            ...
                            <li>
                                <a href="#">Placement Record<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="#">By Session</a>
                                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap "></i>Training Record<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">Visiting Record<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap "></i>Recruitment Statistics<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">Company, year and session wise</a>
                            </li>
                            <li>
                                <a href="#">Company, course, year and session wise</a>
                            </li>                           
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-qrcode "></i>Mailing</a>
                    </li>  
                    <li>
        ...
        <div id="page-wrapper"> 
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <table width="90%">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle;"  >
                                    <input type="number" name="year" min="2" max="5" id="year" style="color: #149bdf;width:110px">                               
                                </td>
                            </tr>
                        </table>
                    </center>
                        ...
                        <table width="100%">
                            <tr>                                                     
                                <td style="vertical-align: middle;text-align: left;">
                                    <input style="color: #149bdf" type="Submit" class="button"  id="save" name="save" value="Course Save">                                    
                                </td>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6">
                       <h5 style="color: #149bdf">Widget Box Two</h5>
